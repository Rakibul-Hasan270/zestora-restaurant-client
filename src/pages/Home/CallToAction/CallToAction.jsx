...
const CallToAction = () => {
    return (
        <div className="">
            <SectionHeading heading='Reserve Your Table Today' subHeading='Avoid the wait — book your table now and enjoy a seamless dining experience with your friends and family.'></SectionHeading>
                ...
                <div className="container flex flex-col items-center px-4 py-12 mx-auto xl:flex-row">
                    ...
                    <div className="flex flex-col items-center mt-6 xl:items-start xl:w-1/2 xl:mt-0">
                        ...
                        <form class="mx-auto w-2/3">
                            ...
                            <button type="submit" class="text-white bg-cyan-700 hover:bg-cyan-800 focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800 mt-2.5">Submit</button>
                        </form>
