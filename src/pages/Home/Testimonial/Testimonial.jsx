                        ...
                        <section>
                            <div className="md:px-6 mx-auto">
                                <main className="relative z-20 w-full md:mt-8 md:flex md:items-center xl:mt-12">
                                    ...
                                    <div className="w-full p-8 bg-cyan-600 md:flex md:items-center rounded-2xl md:bg-transparent md:p-0 lg:px-12 md:justify-evenly">
                                        <img
                                            className="h-24 w-24 
                                             md:mx-6 rounded-full object-cover shadow-md md:h-[32rem] md:w-80 lg:h-[36rem] lg:w-[26rem] md:rounded-2xl"
                                            src={review.image}
                                            alt="client photo"
                                        />
