...
const SignIn = () => {
    ...
    return (
        <div>
            <section className="">
                <div className="container flex items-center justify-center md:min-h-screen px-2 mx-auto">
                    <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-md">
                        <Link className="hidden md:block mb-22 text-center mx-auto gap-3" to='/'>
                            <img className="w-[50px] bg-cyan-800 rounded-full mx-auto" src={logo} alt="" />
                            <p className="text-2xl font-serif text-cyan-500">Zestora Restaurant</p>
                        </Link>
                     ...
                     focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                            ...
                            />
                            {errors.name && <span className="text-red-500 text-xs">Password is required</span>}
                        </div>
