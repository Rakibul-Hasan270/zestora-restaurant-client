        ...
        <section className="mt-12 mb-10">
            <div className="container flex flex-col items-center justify-center px-6 mx-auto  md:h-[700px] md:max-w-2xl bg-white dark:bg-gray-900 rounded-2xl">
               ...
               dark:focus:border-blue-300"
                    ...
                    <div className="mt-6">
                        <button className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-cyan-800 rounded-lg hover:bg-cyan-600 focus:outline-none focus:ring focus:ring-cyan-300 focus:ring-opacity-50">
                            Sign Up
                        </button>
